...
export default function Player() {
    return (
        <div className='h-[10%] bg-black flex justify-between items-center text-white px-3 '>
            {/* songs desc section */}
            ...
            <div className='flex flex-col items-center gap-1 m-auto '>
                ...
                <div className='flex items-center gap-5'>
                    <p>1:06</p>
                    <div className='w-[50vw] max-w-[400px] rounded-full cursor-pointer bg-white'>
